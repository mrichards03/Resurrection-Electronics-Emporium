...
Go
-- Create trigger to populate productInventory when new product created
CREATE TRIGGER updateInventory on product
    AFTER INSERT
    AS
BEGIN
    INSERT INTO productinventory (productId, quantity, warehouseId) VALUES ((select productId from inserted), 0, 1)
END
Go
...
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Chai', 1,1, '10 boxes x 20 bags',18.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Chang',1,1,'24 - 12 oz bottles',19.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Aniseed Syrup',2,1,'12 - 550 ml bottles',10.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Chef Anton''s Cajun Seasoning',2,1,'48 - 6 oz jars',22.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Chef Anton''s Gumbo Mix',2,1,'36 boxes',21.35);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Grandma''s Boysenberry Spread',2,1,'12 - 8 oz jars',25.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Uncle Bob''s Organic Dried Pears',4,1,'12 - 1 lb pkgs.',30.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Northwoods Cranberry Sauce',2,1,'12 - 12 oz jars',40.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Mishi Kobe Niku',5,1,'18 - 500 g pkgs.',97.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Ikura',6,1,'12 - 200 ml jars',31.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Queso Cabrales',3,1,'1 kg pkg.',21.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Queso Manchego La Pastora',3,1,'10 - 500 g pkgs.',38.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Tofu',4,1,'40 - 100 g pkgs.',23.25);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Genen Shouyu',2,1,'24 - 250 ml bottles',15.50);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Pavlova',7,1,'32 - 500 g boxes',17.45);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Alice Mutton',5,1,'20 - 1 kg tins',39.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Carnarvon Tigers',6,1,'16 kg pkg.',62.50);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Teatime Chocolate Biscuits',7,1,'10 boxes x 12 pieces',9.20);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Sir Rodney''s Marmalade',7,1,'30 gift boxes',81.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Sir Rodney''s Scones',7,1,'24 pkgs. x 4 pieces',10.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Gustaf''s Knackebread',8,1,'24 - 500 g pkgs.',21.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Sasquatch Ale',1,1,'24 - 12 oz bottles',14.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Steeleye Stout',1,1,'24 - 12 oz bottles',18.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Inlagd Sill',6,1,'24 - 250 g  jars',19.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Boston Crab Meat',6,1,'24 - 4 oz tins',18.40);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Jack''s New England Clam Chowder',6,1,'12 - 12 oz cans',9.65);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Singaporean Hokkien Fried Mee',8,1,'32 - 1 kg pkgs.',14.00);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Louisiana Fiery Hot Pepper Sauce',2,1,'32 - 8 oz bottles',21.05);
INSERT product(productName, categoryId, brandId, productDesc, productPrice) VALUES ('Laughing Lumberjack Lager',1,1,'24 - 12 oz bottles',14.00);

UPDATE productInventory SET quantity = 5 WHERE productId = 1;
UPDATE productInventory SET quantity = 10 WHERE productId = 2;
UPDATE productInventory SET quantity = 3 WHERE productId = 3;
UPDATE productInventory SET quantity = 2 WHERE productId = 4;
UPDATE productInventory SET quantity = 6 WHERE productId = 5;
UPDATE productInventory SET quantity = 3 WHERE productId = 6;
UPDATE productInventory SET quantity = 1 WHERE productId = 7;
UPDATE productInventory SET quantity = 0 WHERE productId = 8;
UPDATE productInventory SET quantity = 2 WHERE productId = 9;
UPDATE productInventory SET quantity = 3 WHERE productId = 10;
UPDATE productInventory SET quantity = 5 WHERE productId = 11;
UPDATE productInventory SET quantity = 10 WHERE productId = 12;
UPDATE productInventory SET quantity = 3 WHERE productId = 13;
UPDATE productInventory SET quantity = 2 WHERE productId = 14;
UPDATE productInventory SET quantity = 6 WHERE productId = 15;
UPDATE productInventory SET quantity = 3 WHERE productId = 16;
UPDATE productInventory SET quantity = 1 WHERE productId = 17;
UPDATE productInventory SET quantity = 0 WHERE productId = 18;
UPDATE productInventory SET quantity = 2 WHERE productId = 19;
UPDATE productInventory SET quantity = 3 WHERE productId = 20;
UPDATE productInventory SET quantity = 5 WHERE productId = 21;
UPDATE productInventory SET quantity = 10 WHERE productId = 22;
UPDATE productInventory SET quantity = 3 WHERE productId = 23;
UPDATE productInventory SET quantity = 2 WHERE productId = 24;
UPDATE productInventory SET quantity = 6 WHERE productId = 25;
UPDATE productInventory SET quantity = 3 WHERE productId = 26;
UPDATE productInventory SET quantity = 1 WHERE productId = 27;
